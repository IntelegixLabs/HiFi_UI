...
export default function Navbar() {
  ...
  return (
    <Fragment>
      {/* <nav className="w-full py-2 bg-red-200">
      ...
      <div className="sticky top-0 shadow-sm bg-white/60 border-b backdrop-blur-sm">
        <nav className="relative max-w-7xl mx-auto py-2 flex justify-between items-center">
          ...
          <a
            className="hidden lg:inline-block py-2 px-6 border border-red-100 bg-red-50 hover:bg-red-100 text-sm text-red-500 hover:text-red-600 font-semibold rounded-md transition duration-200"
            href="#"
          >
            Logout
          </a>
